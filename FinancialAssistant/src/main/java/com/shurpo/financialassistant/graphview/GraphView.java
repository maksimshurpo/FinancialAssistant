...
package com.shurpo.financialassistant.graphview;
...
import com.shurpo.financialassistant.graphview.GraphViewSeries.GraphViewSeriesStyle;
import com.shurpo.financialassistant.graphview.compatible.ScaleGestureDetector;

/**
 * GraphView is a Android View for creating zoomable and scrollable graphs.
 * This is the abstract base class for all graphs. Extend this class and implement {@link #drawSeries(android.graphics.Canvas, GraphViewDataInterface[], float, float, float, double, double, double, double, float, com.shurpo.financialassistant.graphview.GraphViewSeries.GraphViewSeriesStyle)} (Canvas, GraphViewDataInterface[], float, float, float, double, double, double, double, float)} to display a custom graph.
